  ...
  <div style="width: 1920px;height:100%">
    <section>
      ...
      >
        ...
        <el-table-column prop="id" label="所属班课ID" width="100" sortable></el-table-column>
        <el-table-column prop="user_name" label="任课老师" width="100" sortable></el-table-column>
        <el-table-column prop="user_account" label="学生姓名" width="100" sortable></el-table-column>
        <el-table-column prop="user_sex" label="学生ID" width="100" sortable></el-table-column>
        <el-table-column prop="user_password" label="签到成绩" width="100" sortable></el-table-column>
        <el-table-column prop="user_tel" label="作业成绩" width="150" sortable></el-table-column>
        <el-table-column prop="user_c" label="考试成绩" width="150" sortable></el-table-column>
        <el-table-column prop="user_t" label="总成绩" width="150" sortable></el-table-column>
      ...
      <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false" center>
        <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
          ...
          <el-row type="flex" class="row-bg">
            <el-col :span="12">
              <el-form-item label="签到成绩" prop="user_password">
                <el-input v-model="editForm.user_password" style="width:150px;"></el-input>
              </el-form-item>
            </el-col>
            <el-form-item label="作业成绩" prop="user_tel">
              <el-input v-model="editForm.user_tel" style="width:250px;"></el-input>
            </el-form-item>
          </el-row>
          <el-row type="flex" class="row-bg">
            <el-col :span="12">
              <el-form-item label="考试成绩" prop="user_c">
                <el-input v-model="editForm.user_c" style="width:250px;"></el-input>
              </el-form-item>
            </el-col>
            <el-form-item label="总成绩" prop="user_t">
              <el-input v-model="editForm.user_t" style="width:250px;"></el-input>
            </el-form-item>
          </el-row>
        </el-form>
