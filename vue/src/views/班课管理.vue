    ...
    <section>
      ...
      <el-col :span="22" class="toolbar" style="padding-bottom: 0px;">
        <el-form :inline="true" :model="filters">
          <el-form-item>
            <el-input v-model="filters.name" placeholder="请输入课程姓名"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      >
        ...
        <el-table-column prop="id" label="班课ID" width="150" sortable></el-table-column>
        <el-table-column prop="user_name" label="任课老师" width="150" sortable></el-table-column>
        <el-table-column prop="user_account" label="班课名称" width="150" sortable></el-table-column>
        <el-table-column prop="user_sex" label="开课时间" width="150" sortable></el-table-column>
        <el-table-column prop="user_password" label="学习内容" width="150" sortable></el-table-column>
        <el-table-column prop="user_tel" label="班课成员ID" width="150" sortable></el-table-column>
