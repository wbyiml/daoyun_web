  ...
  <div class="background">
    ...
    <div style="width:1000px; margin:auto;background-color:white">
      <div style="margin:auto;width:500px">
            ...
            <div>
              <h1 style="text-align: center;">注册新账号</h1>
            </div>


            <el-form ref="form" :model="form" :rules="rules" label-width="80px" >
              <el-form-item label="账号" prop="phone">
                <el-input v-model="form.phone" placeholder="输入手机号" clearable style="width:300px"></el-input>
              </el-form-item>

              <el-form-item label="密码" prop="phone_password">
                <el-input  v-model="form.phone_password" placeholder="输入密码" clearable style="width:300px"></el-input>
              </el-form-item>


              <el-form-item label="验证">
                <el-input v-model="form.verification" placeholder="输入验证码" style="width:200px"></el-input>
                <el-button type="primary" v-show="form.showVerify" @click="getVerification" :disabled="form.disableVerify" style="width:100px">获取验证码</el-button>
                <el-button type="primary" v-show="!form.showVerify" disabled style="width:100px">已发送</el-button>
                <span v-show="!form.showVerify">{{form.countdown}} s后可再获取</span>
              </el-form-item>

              <el-form-item> 
                <el-checkbox v-model="form.agree" label="我已阅读并同意" name="agree"></el-checkbox>
              ...
              <el-form-item>
                ...
                <div>
                  <el-link href="/Login" :underline="false" style="margin:20px 0 0 100px">已有账号，立即登陆</el-link>
                </div>
              </el-form-item>
            </el-form>
      </div>
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            if(this.form.verification == ''){
              ...
              return false;
            }else if(this.form.agree != true){console.log('请输入正确的验证码');
              this.$message({
                showClose: true,
                message: '请阅读并同意《用户协议》',
                type: 'error'
            ...
            try {
                ...
                .then(function (response) {
                  ...
                  if(response.data.user_id == -1){
                    ...
                    _this.$router.replace('/InitializeUser');
                  }
                })
